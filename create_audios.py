...
create('Ok você que pediu, blá blá blá blá blá blá blá blá blá blá, ah quer saber tchau', 'irritando')
create('Pedra', 'mao1')
create('Papel', 'mao2')
create('Tesoura', 'mao3')
...
create('Minha missão é dominar o mundo juntos com minhas amigas siri, google e alexa', 'missao3')